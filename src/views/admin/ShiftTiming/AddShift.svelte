  ...
  <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-xl rounded-lg bg-white">
    <div class="rounded-t mb-0 px-4 py-10 border-0">
      <div class="flex flex-wrap items-center">
        ...
        <button class="bg-blueGray-600 text-white active:bg-blueGray-800 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" on:click={navigateToShift}>
          Back
        </button>
      ...
      <div class="flex flex-wrap mb-4">
        <div class="w-full px-4">
          <div class="relative mb-3">
            ...
            <button type="button" class="bg-blue-600 text-white px-3 py-2 rounded ml-2" on:click={addBreak}>Add Break</button>
            {#each breaks as breakTime, index}
              <div class="flex space-x-4 items-center mb-2">
                ...
                <button type="button" class="bg-red-600 text-white px-3 py-2 rounded" on:click={() => removeBreak(index)}>Remove</button>
              </div>
            {/each}
          </div>
        </div>
      ...
      <div class="flex flex-wrap mb-4">
        ...
        <div class="w-full lg:w-4/12 px-4">
          <div class="relative mb-3">
            ...
            <textarea id="notes" name="notes" class="w-full px-3 py-2 border rounded" placeholder="Notes" bind:value={notes}></textarea>
          </div>
        </div>
      </div>
    </div>
