...
<div class="flex flex-wrap">
    <div class="relative min-w-0 break-words bg-white max-w-full mb-6 shadow-xl rounded-lg px-4 py-10"> 
        ...
        <div class="ml-6">
                ...
                <br/>
                <input type="text" id="filterremarks" name="filterremarks" class="filter-input" placeholder="Remarks" bind:value={remarks} style="white-space: wrap;">  </div>   
        <div class="flex flex-wrap">
            <div class="ml-4 switch-label overflow-hidden whitespace-nowrap text-ellipsis">
                <div class="switch">
